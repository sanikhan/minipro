...
class SuppliesControllerTest < ActionController::TestCase
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post :create, supply: { date: @supply.date, product_name: @supply.product_name, quantity: @supply.quantity, supplier_name: @supply.supplier_name }
    end
  ...
  test "should update supply" do
    patch :update, id: @supply, supply: { date: @supply.date, product_name: @supply.product_name, quantity: @supply.quantity, supplier_name: @supply.supplier_name }
    assert_redirected_to supply_path(assigns(:supply))
  end

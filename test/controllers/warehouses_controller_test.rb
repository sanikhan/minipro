...
class WarehousesControllerTest < ActionController::TestCase
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post :create, warehouse: { location: @warehouse.location, name: @warehouse.name, product_name: @warehouse.product_name, stock: @warehouse.stock }
    end
  ...
  test "should update warehouse" do
    patch :update, id: @warehouse, warehouse: { location: @warehouse.location, name: @warehouse.name, product_name: @warehouse.product_name, stock: @warehouse.stock }
    assert_redirected_to warehouse_path(assigns(:warehouse))
  end
